function [particles,localBest,localBestParticles,globalBest,globalBestParticle]=STFBPSO_FindMaxFit(L,L_t,NewU,PseudoLabels_KNN,particles,Z,iteration,PopSize,localBest,localBestParticles,globalBest,globalBestParticle)
